...
const HoverSocial = () => {
  ...
  return (
    <div className="main">
      <div
        className="card"
        onClick={() => linkToSocil("https://instagram.com/codewithharshad")}
      >
        <svg
          className="instagram"
      ...
      <div
        className="card"
        onClick={() => linkToSocil("https://x.com/codewithharshad")}
      >
        <svg
          className="twitter"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <div
        className="card"
        onClick={() =>
          linkToSocil("https://www.linkedin.com/in/codewithharshad")
        }
      >
        <svg
          className="dribble"
      ...
      <div
        className="card"
        onClick={() => linkToSocil("https://github.com/codewithharshad")}
      >
        <svg
          className="github"
          xmlns="http://www.w3.org/2000/svg"
