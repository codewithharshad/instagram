...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex size-12 items-center justify-center rounded-full  border-border bg-white p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
        className,
      )}
    >
      {children}
...
building accessible, user-centered solutions.</h2>
  ...
  <div className="relative flex size-full items-center justify-center overflow-hidden rounded-lg  bg-background p-5 md:shadow-xl">
    <div
      className={cn(
        "relative flex h-[400px] w-full items-center justify-center overflow-hidden rounded-lg  bg-background p-0 md:shadow-xl",
      )}
      ref={containerRef}
    >
      ...
      { <FlickeringGrid
        className="z-0 absolute inset-0 size-full, [mask-image:radial-gradient(circle,white,transparent,transparent)]"
        squareSize={4}
        gridGap={6}
        color="#6B7280"
        maxOpacity={0.5}
