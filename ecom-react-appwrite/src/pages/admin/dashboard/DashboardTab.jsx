...
function DashboardTab() {
    ...
    const { mode, product, edithandle, deleteProduct, order, editOrderhandle, user } = context
                ...
                <div className="tab container mx-auto ">
                    <Tabs defaultIndex={0} className=" " >
                        <TabList className="md:flex md:space-x-8 bg-  grid grid-cols-2 text-center gap-4   md:justify-center mb-10 ">
                            <Tab >
                                <button type="button" className="border-2 border-gray-300 text-primary-gold font-medium     text-xl px-5 py-1.5 text-center bg-[#605d5d12] ">
                                    <div className="flex gap-2 items-center">
                                        <MdOutlineProductionQuantityLimits />Products</div> </button>
                            </Tab>
                            <Tab>
                                <button type="button" className="border-2 border-gray-300 text-primary-gold font-medium   bg-[#605d5d12]    text-xl   px-5 py-1.5 text-center ">
                                    <div className="flex gap-2 items-center">
                        ...
                        <TabPanel>
                            <div className='  px-4 md:px-0 mb-16'>
                                <h1 className=' text-center mb-5 text-3xl font-semibold ' style={{ color: mode === 'dark' ? 'white' : '' }}>
                                    Product Details
                                    </h1>
                                ...
                                <div className=" flex justify-end">
                                    <button
                                        onClick={add}
                                        type="button"
                                        className="add-product focus:outline-none    border   outline-0 font-medium  text-sm px-5 py-2.5 mb-2" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} > <div className="flex gap-2 items-center ">
                                    ...
                                    {allorder.cartItems.map((item,index)=>{
                                        ...
                                        <tr className="bg-gray-50 border-b  dark:border-gray-700" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} >
                                            ...
                                            <Link to={'/updateOrderStatus'}> 
                                                                        <div onClick={() => editOrderhandle(allorder)}  >
